...
public class DataBase {
	...
	public Map<String, Integer> get_labs(String filepath) throws FileNotFoundException {
		Map<String, Integer> all_labs = new HashMap<String, Integer>();
	...
	public void insert(String tablename, int id, String name, String project, int points, int finished,
			String finishedat) throws SQLException {
		String insertsql = "INSERT INTO " + tablename
				+ "(studentId,studentName,projectName,points, completed,datefinished) " + "VALUES(?,?,?,?,?,?)";
	...
	public ArrayList<Project> get_lab_db(String table, String studentname) throws SQLException {
		String query = "SELECT projectName, points, completed, datefinished FROM Class_" + table
		...
		while (rs.next()) {
			...
			projects.add(new Project(rs.getString("projectName"), rs.getInt("points"), rs.getBoolean("completed"),
	...
	public void update_row(String student, String className, Boolean completed, String dateFinished, String lab)
			throws SQLException {
		String sql = "UPDATE " + className
				+ " SET completed = ? , datefinished = ? WHERE studentName = ? and projectName = ?";
