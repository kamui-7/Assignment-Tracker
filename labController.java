...
public class labController implements Initializable{
		...
		@FXML private TableView<Project> labTable;
		@FXML private TableColumn<Project, String> labName;
		@FXML private TableColumn<Project, Integer> points;
		@FXML private TableColumn<Project, Boolean> completed;
		@FXML private TableColumn<Project, Date> datefinished;
