...
public class MainController implements Initializable{
	...
	@FXML private Button firstClass;
	@FXML private Button secondClass;
	@FXML private Button thirdClass;
	@FXML private Button fourthClass;
	
	
	@FXML private Button backLab;
	
	@FXML private MenuItem openLabs;
	@FXML private MenuItem open2B;
	@FXML private MenuItem open3B;
	@FXML private MenuItem open3A;
	@FXML private MenuItem open4B;
	@FXML private MenuItem close;
	
	@FXML private MenuItem queryMenu;
	@FXML private MenuItem schemaMenu;
	...
	@FXML private MenuItem emptydb;
	@FXML private MenuItem recalc;
	...
	public void gotoStuTable(ActionEvent event) throws IOException, SQLException {
        ...
        stuScene.getStylesheets().add(getClass().getResource("Dark Theme.css").toExternalForm());
	...
	public void initialize(URL location, ResourceBundle resources) {
		  ...
		  @Override public void write(int b) throws IOException {
			  ...
			  appendText(String.valueOf((char) b)); } }; System.setOut(new PrintStream(out,
			  true
	  ...
	  public void appendText(String str) { Platform.runLater(() ->
	  queryOutput.appendText(str)); }
